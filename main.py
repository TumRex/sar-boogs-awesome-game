...
def on_on_overlap(sprite3, otherSprite3):
    ...
    ghostie.set_position(randint(90, 80), randint(90, 115))
    ghostie.set_velocity(-30, 0)
...
def on_on_overlap2(sprite, otherSprite):
    ...
    trophy = sprites.create(img("""
        ...
        """),
        SpriteKind.food)
    trophy.set_scale(3, ScaleAnchor.RIGHT)
    trophy.set_position(randint(150, 175), randint(46, 51))
    trophy.set_velocity(-30, 0)
...
rainbowie = sprites.create(assets.image("""
    Rainbow S
"""), SpriteKind.player)
rainbowie.set_scale(2, ScaleAnchor.RIGHT)
ghostie = sprites.create(assets.image("""
    Ghost S
"""), SpriteKind.projectile)
ghostie.set_position(150, 102)
rainbowie.set_position(5, 117)
trophy.set_position(200, 30)
scene.camera_follow_sprite(rainbowie)
rainbowie.set_stay_in_screen(True)
ghostie.set_velocity(-30, 0)
trophy.set_velocity(-30, 0)

def on_forever():
    music.play_melody("C E D - D - D - ", 100)
forever(on_forever)
