...
sprites.onOverlap(SpriteKind.Food, SpriteKind.Enemy, function (sprite, otherSprite) {
    ...
    trophy.setPosition(randint(150, 175), randint(46, 51))
...
game.splash("if you hit the spike you lose a point, if you touch the trophy you get a point. If you get to zero points you lose. If you get to 5 points you win!")
trophy = sprites.create(img`
    ................................
    ................................
    ................................
    ...
    `, SpriteKind.Food)
trophy.setScale(0.7, ScaleAnchor.Right)
guy = sprites.create(assets.image`Rainbow S`, SpriteKind.Player)
guy.setScale(0.7, ScaleAnchor.Right)
spike = sprites.create(assets.image`Ghost S`, SpriteKind.Projectile)
spike.setPosition(150, 102)
guy.setPosition(5, 117)
trophy.setPosition(200, 30)
